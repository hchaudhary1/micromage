...
```bash
# Option 1: Plan-based workflow (micromage-plan-to-merge)
ls -t $ARTIFACTS_DIR/../runs/*/plan-context.md 2>/dev/null | head -1

# Option 2: Issue-based workflow (micromage-fix-github-issue)
...
Then re-request the review: `@micromage review this PR`
```
