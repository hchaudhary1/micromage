...
mkdir -p .micromage/ralph/{feature-slug}
```

### File 1: prd.md

**Output path**: `.micromage/ralph/{feature-slug}/prd.md`
...
**Output path**: `.micromage/ralph/{feature-slug}/prd.json`
...
| File | Purpose |
|------|---------|
| `.micromage/ralph/{feature-slug}/prd.md` | Full context - goals, UX, technical patterns |
| `.micromage/ralph/{feature-slug}/prd.json` | Story tracking - passes/fails per story |
...
1. **Full PRD** (`.micromage/ralph/{feature-slug}/prd.md`) - Goals, persona, UX, technical patterns
2. **Current Story** - From `.micromage/ralph/{feature-slug}/prd.json` with acceptance criteria
3. **Previous Learnings** - From `.micromage/ralph/{feature-slug}/progress.txt`
...
# Initialize progress
echo "# Ralph Progress Log\nStarted: $(date)\n---" > .micromage/ralph/{feature-slug}/progress.txt

# Run Ralph - specify the feature directory
@Micromage run ralph .micromage/ralph/{feature-slug}
```
```
